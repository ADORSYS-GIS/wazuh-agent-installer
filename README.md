...
**macOS:**
```bash
curl -s https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-agent-installer/feat/wazuh-gateway-error-helper/install-scripts/macos.sh | bash -s latest
```

**Linux (Ubuntu):**
```bash
curl -s https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-agent-installer/feat/wazuh-gateway-error-helper/install-scripts/ubuntu.sh | bash -s latest
```

**Windows:**
```powershell
irm https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-agent-installer/feat/wazuh-gateway-error-helper/install-scripts/windows.ps1 | iex
```
